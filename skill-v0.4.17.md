...
- **a topic covers it** -> subscribe, and act on the event when it arrives. Do NOT also poll -- a loop running beside a stream is exactly the cost the stream exists to delete. HOW you wait depends on which KIND of topic it is; see "How to wait" below.
